...
func TestSchemaMatrixLive(t *testing.T) {
	...
	for _, name := range []string{"schema_matrix_live_test.go", "schema_matrix_cases_test.go", "toolschema/schema.go", "toolschema/support.go", "toolschema/native.go", "go.mod", "testdata/schema-matrix/legacy-list-clients.genai.json"} {

...
func applyCacheBreakpoints(params *anthropic.MessageNewParams, cfg *adkmodels.AnthropicPromptCachingConfig) {
...
func newCacheControl(bp *adkmodels.AnthropicCacheBreakpoint) anthropic.CacheControlEphemeralParam {
